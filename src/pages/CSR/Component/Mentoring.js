...
const Mentoring = () => {
  ...
  const description = `The CSR committee is authorised to continuously monitor the CSR Activities and submit its report to the Board on half yearly basis.The CSR committee is authorised to continuously monitor the CSR Activities and submit its report to the Board on half yearly basis.`
  return (
