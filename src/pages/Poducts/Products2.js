          ...
          <div className="flex flex-col max-w-[1600px] gap-[56px]  3xl:gap-[88px]  md:flex-row">
            ...
            ">
              <img
                ...
                w-[266px] h-[252px]"
              />
              <p class="text-[#02111B] font-[Fira Sans] text-[24px] font-[350] leading-[25.2px] tracking-[-0.48px] capitalize">Why HÖGANÄS Powder?</p>
              <div className="flex gap-[12px] flex-wrap">
                {featureTiles?.map((item, index) =>

                  <div className="flex flex-col gap-2 max-w-[250px]">
                    <h4 className="product-spool-number">{`${String(index + 1).padStart(2, '0')}.`}</h4>
                    <p className="text-[#50555B] font-[Fira Sans] text-[14px] font-[350] leading-[22.4px] tracking-[-0.28px]">{item}</p>
                  </div>
